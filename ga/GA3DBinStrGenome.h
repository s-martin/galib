...
class GA3DBinaryStringGenome : public GABinaryString, public GAGenome
{
  ...
  public:
	...
	{
		_evaluated = false;
		return ((bit(z * ny * nx + y * nx + x) == value)
					? value
					: bit(z * ny * nx + y * nx + x, value));
	}
	...
	int resizeBehaviour(Dimension which, unsigned int low, unsigned int upper);
	...
	void copy(const GA3DBinaryStringGenome &, unsigned int, unsigned int,
			  unsigned int, unsigned int, unsigned int, unsigned int,
			  unsigned int, unsigned int, unsigned int);
	int equal(const GA3DBinaryStringGenome &, unsigned int, unsigned int,
			  unsigned int, unsigned int, unsigned int, unsigned int,
