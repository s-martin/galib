...
template <class T>
GAAlleleSetCore<T> &GAAlleleSetCore<T>::
operator=(const GAAlleleSetCore<T> &orig)
{
	if (this == &orig)
		return *this;
...
template <class T>
GAAlleleSetArray<T> &GAAlleleSetArray<T>::
operator=(const GAAlleleSetArray<T> &orig)
{
	if (this == &orig)
		return *this;
	unsigned int i;
...
template <class T>
int GAAlleleSetArray<T>::add(const T &lower, const T &upper,
...
template <class T>
int GAAlleleSetArray<T>::add(const T &lower, const T &upper, const T &increment,
							 GAAllele::BoundType lb, GAAllele::BoundType ub)
{
	if (sz + 1 > SZ)
	{
